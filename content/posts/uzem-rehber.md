---
title: Yüksek Erişilebilir (HA) Uzaktan Eğitim Altyapısı
excerpt: Binlerce öğrenciye kesintisiz hizmet veren Moodle, HAProxy, PostgreSQL, PgBouncer, Redis, NFS ve Scalelite küme mimarisi rehberi.
category: DevOps
date: "2026-09-07"
...
> 🚀 **GitHub Deposu:** [github.com/ostman00/uzem-rehber](https://github.com/ostman00/uzem-rehber) &nbsp;|&nbsp; **Mimari:** Yüksek Erişilebilirlik (HA) & Yük Dengeleme
...
5. [Bölüm 4: Ortak Depolama Katmanı (NFS Server ve İzin Yönetimi)](#bölüm-4-ortak-depolama-katmanı-nfs-server-ve-izin-yönetimi)
6. [Bölüm 5: Scalelite ve BigBlueButton Kümesi](#bölüm-5-scalelite-ve-bigbluebutton-kümesi)
7. [Sorun Giderme İpuçları](#sorun-giderme-ipuçları)
